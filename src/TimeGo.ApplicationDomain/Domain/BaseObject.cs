...
namespace TimeGo.ApplicationDomain.Domain
{
    ...
    ///     Taken directly from S#harp Architecture, slightly modified for ActiveRecord base use.
    ...
    public abstract class BaseObject
    {
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                var propertiesList = signatureProperties.ToList();
                hashCode = propertiesList
        ...
        public virtual bool HasSameObjectSignatureAs(BaseObject compareTo)
        {
            ...
            return propertiesList.Any() || base.Equals(compareTo);
        }
