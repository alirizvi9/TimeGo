...
var TimeoffListComponent = (function () {
    ...
    TimeoffListComponent.prototype.isValid = function (model) {
        if (model.Reasone == "")
            return false;
    ...
    TimeoffListComponent.prototype.cleanAddModel = function () {
        this.addTimeoff = {
            StartDate: new Date(),
            EndDate: new Date(),
            Reasone: "",
