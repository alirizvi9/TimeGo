...
var RatesComponent = (function () {
    ...
    RatesComponent.prototype.cleanAddModel = function () {
        this.addRate = {
            EndDate: new Date(),
            Rate: 0,
            StartDate: new Date(),
